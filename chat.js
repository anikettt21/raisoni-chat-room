...
class RealTimeChatApp {
    ...
    initializeSocket() {
        ...
        try {
            ...
            if ((isLocal && window.location.port !== '3000') || isFile) {
                // If local but not on port 3000 (e.g. Live Server on 5500) or opening file directly, connect to backend port
                debugLog('🔧 Detected local development or file access, connecting to localhost:3000');
